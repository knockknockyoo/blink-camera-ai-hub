...
analyzes 14 representative frames on Apple MPS, while the native service
...
| `RFDETR_MAX_FRAMES` | `14` | Uniformly spaced frames analyzed per video |
| `RFDETR_VEHICLE_MIN_BOX_MOTION` | `0.03` | RF-DETR-only vehicle motion threshold used to reject parked vehicles |
